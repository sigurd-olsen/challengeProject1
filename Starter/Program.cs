...
foreach (string name in studentNames)
{
    ...
    */
    ...
    currentStudentExtraCredit = currentStudentExtraCredit / extraAssignments;
    ...
    Console.WriteLine($"{currentStudent}\t\t{currentStudentExamScore}\t\t{currentStudentGrade}\t{currentStudentLetterGrade}\t{currentStudentExtraCredit} ({currentStudentExtraPoints} pts)");
}
